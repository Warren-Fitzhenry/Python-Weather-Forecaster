...
DS_API_ENPOINT = 'https://api.darksky.net/forecast'
...
def create_get_request(uri: str, payload):
    '''
...
def get_forecast_data(lat: str, lng: str):
    ...
    response = create_get_request(uri, payload)
...
def show_daily_forecast(geo, forecast):
    '''
...
def main():
    ...
    print_header()
    show_daily_forecast(geo_data, forecast_data)
